...
OBJS =		RRMode.o master_thread.o worker_threads.o init_configure.o connection_pool.o
...
$(TARGET):	$(OBJS)
	$(CXX) -o $(TARGET) $(OBJS) $(LIBS) -lpthread -lboost_system -lboost_filesystem -lmysqlcppconn -Wl,-rpath,/usr/local/lib
